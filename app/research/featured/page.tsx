        ...
        <article>
          ...
          <div className="mt-12 w-full">
            ...
            <section className="border-brand-primary-soft bg-brand-primary-soft mt-10 rounded-2xl border p-6">
              <p className="text-brand-primary-soft text-sm font-semibold uppercase tracking-[0.14em]">Key Finding</p>
              <p className="text-brand-primary-soft mt-3 text-3xl font-extrabold">Validity Coefficient (r) = 0.65</p>
